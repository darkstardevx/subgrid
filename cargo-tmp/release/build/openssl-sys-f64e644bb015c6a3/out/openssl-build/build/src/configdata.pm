...
our %config = (
    ...
    "options" => "--prefix=/opt/subgrid/cargo-tmp/release/build/openssl-sys-f64e644bb015c6a3/out/openssl-build/install --openssldir=/usr/local/ssl --libdir=lib -O2 -ffunction-sections -fdata-sections -fPIC -m64 -w no-acvp-tests no-allocfail-tests no-asan no-brotli no-brotli-dynamic no-buildtest-c++ no-camellia no-comp no-crypto-mdebug no-crypto-mdebug-backtrace no-demos no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-jitter no-fips-post no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-h3demo no-hqinterop no-idea no-jitter no-ktls no-lms no-loadereng no-md2 no-module no-msan no-pie no-rc5 no-sctp no-seed no-shared no-ssl3 no-ssl3-method no-sslkeylog no-tests no-tfo no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-winstore no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "2",
    "perl_archname" => "x86_64-linux-gnu-thread-multi",
    "perl_cmd" => "/usr/bin/perl",
    "perl_version" => "5.40.1",
    "perlargv" => [
        "--prefix=/opt/subgrid/cargo-tmp/release/build/openssl-sys-f64e644bb015c6a3/out/openssl-build/install",
        "--openssldir=/usr/local/ssl",
        "no-shared",
        "no-module",
        "no-tests",
...
our %unified_info = (
    ...
    "dirinfo" => {
        ...
        "crypto/aes" => {
            "deps" => [
                "crypto/aes/libcrypto-lib-aes-cfb-avx512.o",
...
unless (caller) {
    ...
    use lib '/opt/subgrid/cargo-tmp/release/build/openssl-sys-f64e644bb015c6a3/out/openssl-build/build/src/util/perl';
    use OpenSSL::fallback '/opt/subgrid/cargo-tmp/release/build/openssl-sys-f64e644bb015c6a3/out/openssl-build/build/src/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/opt/subgrid/cargo-tmp/release/build/openssl-sys-f64e644bb015c6a3/out/openssl-build/build/src/Configurations';
        use gentemplate;
